...
import { Calendar, Clock, MapPin, Users, Star, Gift, Music, Utensils, Camera, Heart } from 'lucide-react'
  ...
  const tetActivities = [
    {
      ...
      description: 'Lion and dragon dances, Vietnamese folk music, and traditional instrument performances',
    ...
    },
    {
      ...
      description: 'Traditional Tết dishes including bánh chưng, nem rán, and special holiday sweets',
  ...
  const tetHistory = [
    {
      ...
      description: 'Tết Nguyên Đán, marking the first day of spring and the Vietnamese New Year, has been celebrated for over 4,000 years.'
    },
    {
      year: 'Customs',
      title: 'Sacred Rituals',
      description: 'Families honor ancestors, clean homes for good luck, and prepare special foods to welcome prosperity.'
    },
    {
      year: 'Modern',
      title: 'Global Celebration',
      description: 'Vietnamese communities worldwide maintain these cherished traditions while adapting to new environments.'
    }
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <AnimatedSection direction="left">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Celebrate the Year of the Snake with Iowa State&apos;s largest Vietnamese cultural celebration. 
                Experience authentic traditions, delicious food, and vibrant performances that bring our community together.
              </p>
            ...
            <AnimatedSection direction="right">
              <div className="relative h-96 rounded-xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  ...
                  <p className="text-sm opacity-90">Traditional lion dances, Vietnamese cuisine, and cultural performances</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
            ...
            {tetActivities.map((activity, index) => (
              ...
              >
                <div className="card h-full text-center">
                  <div className={`w-20 h-20 bg-gradient-to-br ${activity.color} rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg`}>
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection direction="up" className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Be part of Iowa State&apos;s most vibrant cultural celebration and welcome the Year of the Snake with us
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                whileHover={{ scale: 1.05 }}
