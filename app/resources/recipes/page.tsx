...
import { Search, Clock, Users, ChefHat, Heart, Star, Filter, Download, Utensils } from 'lucide-react'
...
export default function RecipesPage() {
  ...
  const recipes = [
    {
      ...
      servings: 6,
      rating: 4.9,
      ingredients: ['Beef bones', 'Rice noodles', 'Onions', 'Ginger', 'Star anise', 'Cinnamon', 'Fish sauce'],
    ...
    },
    {
      ...
      servings: 4,
      rating: 4.7,
      ingredients: ['Baguette', 'Pâté', 'Pickled vegetables', 'Cilantro', 'Jalapeños', 'Vietnamese cold cuts'],
    ...
    },
    {
      ...
      servings: 4,
      rating: 4.6,
      ingredients: ['Rice paper', 'Shrimp', 'Pork belly', 'Rice noodles', 'Lettuce', 'Herbs', 'Peanut sauce'],
    ...
    },
    {
      ...
      servings: 4,
      rating: 4.8,
      ingredients: ['Pork shoulder', 'Rice noodles', 'Fish sauce', 'Sugar', 'Herbs', 'Pickled vegetables'],
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'soup': return 'from-blue-500 to-blue-700'
      case 'main': return 'from-red-500 to-red-700'
      case 'appetizer': return 'from-green-500 to-green-700'
      case 'dessert': return 'from-pink-500 to-pink-700'
      case 'sandwich': return 'from-orange-500 to-orange-700'
              ...
              >
                <div className="card h-full">
                  <div className="relative h-48 mb-4 rounded-lg overflow-hidden">
                    ...
                    />
                    <div className="absolute top-2 left-2">
                      <span className={`px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r ${getCategoryColor(recipe.category)}`}>
