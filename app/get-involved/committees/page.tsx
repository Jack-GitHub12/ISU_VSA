  ...
  const committees = [
    {
      ...
      responsibilities: ['Plan cultural celebrations', 'Organize workshops', 'Coordinate guest speakers', 'Manage cultural exhibits'],
    ...
    },
    {
      ...
      responsibilities: ['Organize social events', 'Plan mixers and networking', 'Coordinate recreational activities', 'Build community connections'],
    ...
    },
    {
      ...
      responsibilities: ['Manage social media', 'Create promotional materials', 'Handle publicity', 'Coordinate outreach'],
    ...
    },
    {
      ...
      responsibilities: ['Plan service projects', 'Coordinate volunteering', 'Partner with local organizations', 'Track service hours'],
    ...
    },
    {
      ...
      responsibilities: ['Budget management', 'Fundraising events', 'Financial reporting', 'Grant applications'],
    ...
    },
    {
      ...
      responsibilities: ['Event photography', 'Video production', 'Content creation', 'Website maintenance'],
      commitment: '5-8 hours/week',
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection direction="up" className="text-center">
            ...
            <p className="text-xl md:text-2xl max-w-4xl mx-auto">
              Join a committee and help shape the future of VSA while developing valuable leadership skills
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <AnimatedSection direction="up" className="text-center mb-12">
            ...
            <p className="section-subtitle">Find the perfect way to contribute your skills and interests</p>
          </AnimatedSection>
            ...
            {committees.map((committee, index) => (
              ...
              >
                <div className="card h-full">
                  <div className={`w-16 h-16 bg-gradient-to-br ${committee.color} rounded-full flex items-center justify-center mx-auto mb-4`}>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {committee.positions.map((position) => (
                        <span key={position} className="bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs">
                          {position}
                        </span>
                      ))}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <AnimatedSection direction="up" delay={0.3}>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Directly contribute to events and initiatives that benefit the entire VSA community
                </p>
              </div>
            </AnimatedSection>
          </div>
